...
const ExamplesPage = () => {
 const examples = PageList.filter((page) =>
    ...
    <Layout>
      <Container style={{ maxWidth: "500px" }}>
        ...
        <p className="lead text-center">
          Here are some examples of React-Bootstrap components being used to
          create layouts.
        </p>
        <p className="lead text-center">
          Whilst they have limited functionality, they serve as pointers for
          creating simple, user-friendly designs for various use-cases.
        </p>
